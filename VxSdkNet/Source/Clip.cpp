...
VxSdkNet::Clip::Clip(VxSdk::IVxClip* vxClip) {
    _clip = vxClip;
}
...
List<VxSdkNet::DataInterface^>^ VxSdkNet::Clip::_GetDataInterfaces() {
...
int GetFilterSize(VxSdkNet::SnapshotFilter^ filter) {
    int filterSize = 0;
...
System::String^ VxSdkNet::Clip::GetSnapshotEndpoint(SnapshotFilter^ filter) {
