...
namespace VxSdkNet {
    ...
    public:
        ...
        VxSdkNet::Results::Value DeletePreset(Preset^ preset);
        ...
        System::Collections::Generic::List<Pattern^>^ GetPatterns(System::Collections::Generic::Dictionary<Filters::Value, System::String^>^ filters);
        ...
        System::Collections::Generic::List<Preset^>^ GetPresets(System::Collections::Generic::Dictionary<Filters::Value, System::String^>^ filters);
        ...
        /// values pan right.</param>
        /// <returns>The <see cref="Results::Value">Result</see> of the relative move.
        /// </returns>
        ...
        /// </summary>
        /// <returns>A <c>List</c> of patterns.</returns>
        property System::Collections::Generic::List<Pattern^>^ Patterns {
        public:
            System::Collections::Generic::List<Pattern^>^ get() { return GetPatterns(nullptr); }
        }
        ...
        /// </summary>
        /// <returns>A <c>List</c> of presets.</returns>
        property System::Collections::Generic::List<Preset^>^ Presets {
        public:
            System::Collections::Generic::List<Preset^>^ get() { return GetPresets(nullptr); }
        }
        ...
        public:
            ...
            void set (int value) {
                int x, y, z;
                _ptzController->GetPosition(x, y, z);
                _ptzController->AbsoluteMove(value, y, z);
            }
        }
        ...
        public:
            ...
            void set (int value) {
                int x, y, z;
                _ptzController->GetPosition(x, y, z);
                _ptzController->AbsoluteMove(x, value, z);
            }
        }
        ...
        public:
            ...
            void set (int value) {
                int x, y, z;
                _ptzController->GetPosition(x, y, z);
                _ptzController->AbsoluteMove(x, y, value);
            }
        }
