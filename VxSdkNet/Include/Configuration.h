...
namespace VxSdkNet {
    ...
    public:
        ...
        public:
            ...
            property VxSdkNet::Configuration::MotionMode Mode {
            public:
                VxSdkNet::Configuration::MotionMode get() { return (VxSdkNet::Configuration::MotionMode)_configMotion->mode; }
                void set(VxSdkNet::Configuration::MotionMode value) { _configMotion->SetMode((VxSdk::VxMotionMode::Value)value); }
            }
